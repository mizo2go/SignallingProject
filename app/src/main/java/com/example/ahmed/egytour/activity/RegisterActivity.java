...
import com.example.ahmed.egytour.app.AppConfig;
import com.example.ahmed.egytour.app.AppController;
...
public class RegisterActivity extends Activity {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    registerUser(name, email, password,nationality,age,phonenumber);
                } else {
    ...
    private void registerUser(final String name, final String email,
                              final String password,final String nationality,final String age, final String phonenumber) {
